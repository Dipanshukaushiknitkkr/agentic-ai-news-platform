...
# Ensure root and backend directories are always in Python module search path
...
# Import database, auth, models, services
try:
...
# Resolve templates and static directories safely
